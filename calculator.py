...
if __name__ == "__main__":
	...
	expression_field = Entry(gui,justify='center',font=('Arial',15), textvariable=equation)
	...
	clear = Button(gui, text='RESET  /  C', fg='black', bg='white',
				command=clear, height=2, width=15)
	#clear.grid(row=6, column='0')
	clear.place(x=110,y=200)
